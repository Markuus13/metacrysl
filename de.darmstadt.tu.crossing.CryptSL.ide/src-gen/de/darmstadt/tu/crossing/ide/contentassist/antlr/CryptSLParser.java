...
public class CryptSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CryptSLGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getDomainmodelAccess().getAlternatives(), "rule__Domainmodel__Alternatives");
			builder.put(grammarAccess.getOperationsAccess().getOperationsAlternatives_0(), "rule__Operations__OperationsAlternatives_0");
			builder.put(grammarAccess.getMetaCryslAccess().getAlternatives_3(), "rule__MetaCrysl__Alternatives_3");
			...
			builder.put(grammarAccess.getConsAccess().getAlternatives_0_2(), "rule__Cons__Alternatives_0_2");
			...
			builder.put(grammarAccess.getAddConstraintAccess().getGroup(), "rule__AddConstraint__Group__0");
			builder.put(grammarAccess.getMetaCryslAccess().getGroup(), "rule__MetaCrysl__Group__0");
			builder.put(grammarAccess.getMetaCryslAccess().getGroup_3_1(), "rule__MetaCrysl__Group_3_1__0");
			builder.put(grammarAccess.getMetaCryslAccess().getGroup_6(), "rule__MetaCrysl__Group_6__0");
			builder.put(grammarAccess.getMetaCryslAccess().getGroup_11(), "rule__MetaCrysl__Group_11__0");
			builder.put(grammarAccess.getMetaCryslAccess().getGroup_12(), "rule__MetaCrysl__Group_12__0");
			builder.put(grammarAccess.getMetaCryslAccess().getGroup_13(), "rule__MetaCrysl__Group_13__0");
			builder.put(grammarAccess.getMetaCryslAccess().getGroup_14(), "rule__MetaCrysl__Group_14__0");
			...
			builder.put(grammarAccess.getConsAccess().getGroup_0_2_0(), "rule__Cons__Group_0_2_0__0");
			...
			builder.put(grammarAccess.getRefinementAccess().getRefinementIdAssignment_1(), "rule__Refinement__RefinementIdAssignment_1");
			builder.put(grammarAccess.getRefinementAccess().getJavaTypeAssignment_3(), "rule__Refinement__JavaTypeAssignment_3");
			builder.put(grammarAccess.getRefinementAccess().getOperationsAssignment_5(), "rule__Refinement__OperationsAssignment_5");
			builder.put(grammarAccess.getOperationsAccess().getOperationsAssignment(), "rule__Operations__OperationsAssignment");
			builder.put(grammarAccess.getDefinitionsAccess().getDefinitionsAssignment(), "rule__Definitions__DefinitionsAssignment");
			builder.put(grammarAccess.getDefinitionAccess().getMetaVariableAssignment_1(), "rule__Definition__MetaVariableAssignment_1");
			builder.put(grammarAccess.getDefinitionAccess().getAlgorithmsAssignment_4(), "rule__Definition__AlgorithmsAssignment_4");
			builder.put(grammarAccess.getAddConstraintsAccess().getAddConstraintsAssignment(), "rule__AddConstraints__AddConstraintsAssignment");
			builder.put(grammarAccess.getAddConstraintAccess().getConstraintAssignment_2(), "rule__AddConstraint__ConstraintAssignment_2");
			builder.put(grammarAccess.getMetaCryslAccess().getJavaTypeAssignment_2(), "rule__MetaCrysl__JavaTypeAssignment_2");
			builder.put(grammarAccess.getMetaCryslAccess().getArrayAssignment_3_0(), "rule__MetaCrysl__ArrayAssignment_3_0");
			builder.put(grammarAccess.getMetaCryslAccess().getGenericTypeAssignment_3_1_1(), "rule__MetaCrysl__GenericTypeAssignment_3_1_1");
			builder.put(grammarAccess.getMetaCryslAccess().getUsageAssignment_5(), "rule__MetaCrysl__UsageAssignment_5");
			builder.put(grammarAccess.getMetaCryslAccess().getForbEventAssignment_6_1(), "rule__MetaCrysl__ForbEventAssignment_6_1");
			builder.put(grammarAccess.getMetaCryslAccess().getReq_eventsAssignment_8(), "rule__MetaCrysl__Req_eventsAssignment_8");
			builder.put(grammarAccess.getMetaCryslAccess().getOrderAssignment_10(), "rule__MetaCrysl__OrderAssignment_10");
			builder.put(grammarAccess.getMetaCryslAccess().getReqConstraintsAssignment_11_1(), "rule__MetaCrysl__ReqConstraintsAssignment_11_1");
			builder.put(grammarAccess.getMetaCryslAccess().getRequireAssignment_12_1(), "rule__MetaCrysl__RequireAssignment_12_1");
			builder.put(grammarAccess.getMetaCryslAccess().getEnsureAssignment_13_1(), "rule__MetaCrysl__EnsureAssignment_13_1");
			builder.put(grammarAccess.getMetaCryslAccess().getDestroyAssignment_14_1(), "rule__MetaCrysl__DestroyAssignment_14_1");
			...
			builder.put(grammarAccess.getConsAccess().getLitsleftAssignment_0_2_0_1(), "rule__Cons__LitsleftAssignment_0_2_0_1");
			builder.put(grammarAccess.getConsAccess().getMetaVariableAssignment_0_2_1(), "rule__Cons__MetaVariableAssignment_0_2_1");
