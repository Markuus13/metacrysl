 ...
 *   <li>{@link de.darmstadt.tu.crossing.cryptSL.Constraint#getPredLit <em>Pred Lit</em>}</li>
...
public interface Constraint extends EObject
{
   ...
   * @see de.darmstadt.tu.crossing.cryptSL.CryptSLPackage#getConstraint_PredLit()
   * @model containment="true"
   * @generated
   */
  PredLit getPredLit();
  ...
  /**
   * Sets the value of the '{@link de.darmstadt.tu.crossing.cryptSL.Constraint#getPredLit <em>Pred Lit</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
