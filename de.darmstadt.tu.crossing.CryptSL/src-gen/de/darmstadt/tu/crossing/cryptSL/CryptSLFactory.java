...
public interface CryptSLFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Add Constraints</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Add Constraints</em>'.
   * @generated
   */
  AddConstraints createAddConstraints();
  ...
  /**
   * Returns a new object of class '<em>Meta Crysl</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Meta Crysl</em>'.
   * @generated
   */
  MetaCrysl createMetaCrysl();
