 ...
 *   <li>{@link de.darmstadt.tu.crossing.cryptSL.LiteralExpression#getMetaVariable <em>Meta Variable</em>}</li>
...
public interface LiteralExpression extends Constraint
{
   ...
   * @see de.darmstadt.tu.crossing.cryptSL.CryptSLPackage#getLiteralExpression_MetaVariable()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.darmstadt.tu.crossing.cryptSL.LiteralExpression#getMetaVariable <em>Meta Variable</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
