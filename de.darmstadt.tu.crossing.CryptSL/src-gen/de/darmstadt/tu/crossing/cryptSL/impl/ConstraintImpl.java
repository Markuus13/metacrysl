 ...
 *   <li>{@link de.darmstadt.tu.crossing.cryptSL.impl.ConstraintImpl#getPredLit <em>Pred Lit</em>}</li>
...
public class ConstraintImpl extends MinimalEObjectImpl.Container implements Constraint
{
  ...
  public NotificationChain basicSetPredLit(PredLit newPredLit, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CryptSLPackage.CONSTRAINT__PRED_LIT, oldPredLit, newPredLit);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setPredLit(PredLit newPredLit)
  {
    if (newPredLit != predLit)
    {
      NotificationChain msgs = null;
      if (predLit != null)
        msgs = ((InternalEObject)predLit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CryptSLPackage.CONSTRAINT__PRED_LIT, null, msgs);
      if (newPredLit != null)
        msgs = ((InternalEObject)newPredLit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CryptSLPackage.CONSTRAINT__PRED_LIT, null, msgs);
      msgs = basicSetPredLit(newPredLit, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CryptSLPackage.CONSTRAINT__PRED_LIT, newPredLit, newPredLit));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case CryptSLPackage.CONSTRAINT__PRED_LIT:
