...
import de.darmstadt.tu.crossing.cryptSL.JvmTypeReference;
...
public class CryptSLPackageImpl extends EPackageImpl implements CryptSLPackage
{
   ...
   * @generated
   */
  private EClass addConstraintsEClass = null;
   ...
   * @generated
   */
  private EClass metaCryslEClass = null;
   ...
   */
  @Override
  public EAttribute getRefinement_RefinementId()
  {
   ...
   */
  @Override
  public EReference getRefinement_Operations()
  {
   ...
   */
  @Override
  public EAttribute getDefinition_MetaVariable()
  {
   ...
   */
  @Override
  public EReference getDefinition_Algorithms()
  {
   ...
   */
  @Override
  public EClass getAddConstraints()
  {
    return addConstraintsEClass;
  }
   ...
   */
  @Override
  public EReference getAddConstraints_AddConstraints()
  {
    return (EReference)addConstraintsEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EClass getMetaCrysl()
  {
    return metaCryslEClass;
  }
   ...
   */
  @Override
  public EAttribute getMetaCrysl_Array()
  {
    return (EAttribute)metaCryslEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getMetaCrysl_GenericType()
  {
    return (EAttribute)metaCryslEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getMetaCrysl_Usage()
  {
    return (EReference)metaCryslEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EReference getMetaCrysl_ForbEvent()
  {
    return (EReference)metaCryslEClass.getEStructuralFeatures().get(3);
  }
   ...
   */
  @Override
  public EReference getMetaCrysl_Req_events()
  {
    return (EReference)metaCryslEClass.getEStructuralFeatures().get(4);
  }
   ...
   */
  @Override
  public EReference getMetaCrysl_Order()
  {
    return (EReference)metaCryslEClass.getEStructuralFeatures().get(5);
  }
   ...
   */
  @Override
  public EReference getMetaCrysl_ReqConstraints()
  {
    return (EReference)metaCryslEClass.getEStructuralFeatures().get(6);
  }
   ...
   */
  @Override
  public EReference getMetaCrysl_Require()
  {
    return (EReference)metaCryslEClass.getEStructuralFeatures().get(7);
  }
   ...
   */
  @Override
  public EReference getMetaCrysl_Ensure()
  {
    return (EReference)metaCryslEClass.getEStructuralFeatures().get(8);
  }
   ...
   */
  @Override
  public EReference getMetaCrysl_Destroy()
  {
    return (EReference)metaCryslEClass.getEStructuralFeatures().get(9);
  }
   ...
   */
  @Override
  public EAttribute getLiteralExpression_MetaVariable()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(refinementEClass, REFINEMENT__REFINEMENT_ID);
    createEReference(refinementEClass, REFINEMENT__OPERATIONS);

    operationsEClass = createEClass(OPERATIONS);
    createEReference(operationsEClass, OPERATIONS__OPERATIONS);

    definitionsEClass = createEClass(DEFINITIONS);
    createEReference(definitionsEClass, DEFINITIONS__DEFINITIONS);

    definitionEClass = createEClass(DEFINITION);
    createEAttribute(definitionEClass, DEFINITION__META_VARIABLE);
    createEReference(definitionEClass, DEFINITION__ALGORITHMS);

    addConstraintsEClass = createEClass(ADD_CONSTRAINTS);
    createEReference(addConstraintsEClass, ADD_CONSTRAINTS__ADD_CONSTRAINTS);

    addConstraintEClass = createEClass(ADD_CONSTRAINT);
    createEReference(addConstraintEClass, ADD_CONSTRAINT__CONSTRAINT);

    metaCryslEClass = createEClass(META_CRYSL);
    createEAttribute(metaCryslEClass, META_CRYSL__ARRAY);
    createEAttribute(metaCryslEClass, META_CRYSL__GENERIC_TYPE);
    createEReference(metaCryslEClass, META_CRYSL__USAGE);
    createEReference(metaCryslEClass, META_CRYSL__FORB_EVENT);
    createEReference(metaCryslEClass, META_CRYSL__REQ_EVENTS);
    createEReference(metaCryslEClass, META_CRYSL__ORDER);
    createEReference(metaCryslEClass, META_CRYSL__REQ_CONSTRAINTS);
    createEReference(metaCryslEClass, META_CRYSL__REQUIRE);
    createEReference(metaCryslEClass, META_CRYSL__ENSURE);
    createEReference(metaCryslEClass, META_CRYSL__DESTROY);
    ...
    createEAttribute(literalExpressionEClass, LITERAL_EXPRESSION__META_VARIABLE);
  ...
  public void initializePackageContents()
  {
    ...
    refinementEClass.getESuperTypes().add(this.getDomainmodel());
    metaCryslEClass.getESuperTypes().add(this.getDomainmodel());
    ...
    initEAttribute(getRefinement_RefinementId(), ecorePackage.getEString(), "refinementId", null, 0, 1, Refinement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRefinement_Operations(), this.getOperations(), null, "operations", null, 0, 1, Refinement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(operationsEClass, Operations.class, "Operations", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getOperations_Operations(), ecorePackage.getEObject(), null, "operations", null, 0, -1, Operations.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(definitionsEClass, Definitions.class, "Definitions", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDefinitions_Definitions(), this.getDefinition(), null, "definitions", null, 0, -1, Definitions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(definitionEClass, Definition.class, "Definition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getDefinition_MetaVariable(), ecorePackage.getEString(), "metaVariable", null, 0, 1, Definition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDefinition_Algorithms(), this.getLitList(), null, "algorithms", null, 0, 1, Definition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(addConstraintsEClass, AddConstraints.class, "AddConstraints", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAddConstraints_AddConstraints(), this.getAddConstraint(), null, "addConstraints", null, 0, -1, AddConstraints.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(addConstraintEClass, AddConstraint.class, "AddConstraint", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getAddConstraint_Constraint(), this.getConstraint(), null, "constraint", null, 0, 1, AddConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(metaCryslEClass, MetaCrysl.class, "MetaCrysl", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getMetaCrysl_Array(), ecorePackage.getEString(), "array", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMetaCrysl_GenericType(), ecorePackage.getEString(), "genericType", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMetaCrysl_Usage(), this.getUseBlock(), null, "usage", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMetaCrysl_ForbEvent(), this.getForbiddenBlock(), null, "forbEvent", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMetaCrysl_Req_events(), this.getRequiredBlock(), null, "req_events", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMetaCrysl_Order(), this.getExpression(), null, "order", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMetaCrysl_ReqConstraints(), this.getEnforceConsBlock(), null, "reqConstraints", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMetaCrysl_Require(), this.getRequiresBlock(), null, "require", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMetaCrysl_Ensure(), this.getEnsuresBlock(), null, "ensure", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getMetaCrysl_Destroy(), this.getDestroysBlock(), null, "destroy", null, 0, 1, MetaCrysl.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getLiteralExpression_MetaVariable(), ecorePackage.getEString(), "metaVariable", null, 0, 1, LiteralExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
