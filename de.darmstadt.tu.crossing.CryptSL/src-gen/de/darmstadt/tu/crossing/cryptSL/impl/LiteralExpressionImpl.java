 ...
 *   <li>{@link de.darmstadt.tu.crossing.cryptSL.impl.LiteralExpressionImpl#getMetaVariable <em>Meta Variable</em>}</li>
...
public class LiteralExpressionImpl extends ConstraintImpl implements LiteralExpression
{
  ...
  public void setMetaVariable(String newMetaVariable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CryptSLPackage.LITERAL_EXPRESSION__META_VARIABLE, oldMetaVariable, metaVariable));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case CryptSLPackage.LITERAL_EXPRESSION__LITSLEFT:
        return getLitsleft();
      case CryptSLPackage.LITERAL_EXPRESSION__META_VARIABLE:
