...
public class CryptSLSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_MetaCrysl_ABSTRACTKeyword_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_MetaCrysl_ABSTRACTKeyword_0_q = new TokenAlias(false, true, grammarAccess.getMetaCryslAccess().getABSTRACTKeyword_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_MetaCrysl_ABSTRACTKeyword_0_q.equals(syntax))
				emit_MetaCrysl_ABSTRACTKeyword_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     (rule start) (ambiguity) 'SPEC' javaType=[JvmType|QualifiedName]
	 */
	protected void emit_MetaCrysl_ABSTRACTKeyword_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
