...
public class CryptSLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class DomainmodelElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cMetaCryslParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cRefinementParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		
		//Domainmodel:
		//	MetaCrysl | Refinement;
		...
		//MetaCrysl
		public RuleCall getMetaCryslParserRuleCall_0() { return cMetaCryslParserRuleCall_0; }
	...
	public class RefinementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.Refinement");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cSPECKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cRefinementIdAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cRefinementIdIDTerminalRuleCall_1_0 = (RuleCall)cRefinementIdAssignment_1.eContents().get(0);
		private final Keyword cREFINESKeyword_2 = (Keyword)cGroup.eContents().get(2);
		...
		//Refinement:
		//	'SPEC' refinementId=ID 'REFINES' javaType=[jvmTypes::JvmType|QualifiedName] '{'
		//	operations=Operations
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//'SPEC' refinementId=ID 'REFINES' javaType=[jvmTypes::JvmType|QualifiedName] '{' operations=Operations '}'
		...
		//refinementId=ID
		public Assignment getRefinementIdAssignment_1() { return cRefinementIdAssignment_1; }
		
		//ID
		public RuleCall getRefinementIdIDTerminalRuleCall_1_0() { return cRefinementIdIDTerminalRuleCall_1_0; }
		
		//'REFINES'
		public Keyword getREFINESKeyword_2() { return cREFINESKeyword_2; }
	...
	public class OperationsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.Operations");
		private final Assignment cOperationsAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cOperationsAlternatives_0 = (Alternatives)cOperationsAssignment.eContents().get(0);
		private final RuleCall cOperationsDefinitionsParserRuleCall_0_0 = (RuleCall)cOperationsAlternatives_0.eContents().get(0);
		private final RuleCall cOperationsAddConstraintsParserRuleCall_0_1 = (RuleCall)cOperationsAlternatives_0.eContents().get(1);
		
		//Operations:
		//	operations+=(Definitions | AddConstraints)+;
		@Override public ParserRule getRule() { return rule; }
		
		//operations+=(Definitions | AddConstraints)+
		public Assignment getOperationsAssignment() { return cOperationsAssignment; }
		
		//(Definitions | AddConstraints)
		public Alternatives getOperationsAlternatives_0() { return cOperationsAlternatives_0; }
		
		//Definitions
		public RuleCall getOperationsDefinitionsParserRuleCall_0_0() { return cOperationsDefinitionsParserRuleCall_0_0; }
		
		//AddConstraints
		public RuleCall getOperationsAddConstraintsParserRuleCall_0_1() { return cOperationsAddConstraintsParserRuleCall_0_1; }
	}
	public class DefinitionsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.Definitions");
	...
	public class DefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.Definition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cDefineKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cMetaVariableAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cMetaVariableIDTerminalRuleCall_1_0 = (RuleCall)cMetaVariableAssignment_1.eContents().get(0);
		private final Keyword cEqualsSignKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Keyword cLeftCurlyBracketKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cAlgorithmsAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final RuleCall cAlgorithmsLitListParserRuleCall_4_0 = (RuleCall)cAlgorithmsAssignment_4.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_5 = (Keyword)cGroup.eContents().get(5);
		private final Keyword cSemicolonKeyword_6 = (Keyword)cGroup.eContents().get(6);
		
		//Definition:
		//	'define' metaVariable=ID '=' '{' algorithms=LitList '}' ';';
		@Override public ParserRule getRule() { return rule; }
		...
		//metaVariable=ID
		public Assignment getMetaVariableAssignment_1() { return cMetaVariableAssignment_1; }
		
		//ID
		public RuleCall getMetaVariableIDTerminalRuleCall_1_0() { return cMetaVariableIDTerminalRuleCall_1_0; }
		...
		//algorithms=LitList
		public Assignment getAlgorithmsAssignment_4() { return cAlgorithmsAssignment_4; }
		
		//LitList
		public RuleCall getAlgorithmsLitListParserRuleCall_4_0() { return cAlgorithmsLitListParserRuleCall_4_0; }
	...
	public class AddConstraintsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.AddConstraints");
		private final Assignment cAddConstraintsAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cAddConstraintsAddConstraintParserRuleCall_0 = (RuleCall)cAddConstraintsAssignment.eContents().get(0);
		...
		//addConstraints+=AddConstraint
		public Assignment getAddConstraintsAssignment() { return cAddConstraintsAssignment; }
		
		//AddConstraint
		public RuleCall getAddConstraintsAddConstraintParserRuleCall_0() { return cAddConstraintsAddConstraintParserRuleCall_0; }
	}
	public class AddConstraintElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.AddConstraint");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MetaCryslElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cJavaTypeAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final CrossReference cJavaTypeJvmTypeCrossReference_2_0 = (CrossReference)cJavaTypeAssignment_2.eContents().get(0);
		private final RuleCall cJavaTypeJvmTypeQualifiedNameParserRuleCall_2_0_1 = (RuleCall)cJavaTypeJvmTypeCrossReference_2_0.eContents().get(1);
		private final Alternatives cAlternatives_3 = (Alternatives)cGroup.eContents().get(3);
		private final Assignment cArrayAssignment_3_0 = (Assignment)cAlternatives_3.eContents().get(0);
		private final Keyword cArrayLeftSquareBracketRightSquareBracketKeyword_3_0_0 = (Keyword)cArrayAssignment_3_0.eContents().get(0);
		private final Group cGroup_3_1 = (Group)cAlternatives_3.eContents().get(1);
		private final Keyword cLessThanSignKeyword_3_1_0 = (Keyword)cGroup_3_1.eContents().get(0);
		private final Assignment cGenericTypeAssignment_3_1_1 = (Assignment)cGroup_3_1.eContents().get(1);
		private final RuleCall cGenericTypeQualifiedNameParserRuleCall_3_1_1_0 = (RuleCall)cGenericTypeAssignment_3_1_1.eContents().get(0);
		private final Keyword cGreaterThanSignKeyword_3_1_2 = (Keyword)cGroup_3_1.eContents().get(2);
		private final Keyword cOBJECTSKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Assignment cUsageAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cUsageUseBlockParserRuleCall_5_0 = (RuleCall)cUsageAssignment_5.eContents().get(0);
		private final Group cGroup_6 = (Group)cGroup.eContents().get(6);
		private final Keyword cFORBIDDENKeyword_6_0 = (Keyword)cGroup_6.eContents().get(0);
		private final Assignment cForbEventAssignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final RuleCall cForbEventForbiddenBlockParserRuleCall_6_1_0 = (RuleCall)cForbEventAssignment_6_1.eContents().get(0);
		private final Keyword cEVENTSKeyword_7 = (Keyword)cGroup.eContents().get(7);
		private final Assignment cReq_eventsAssignment_8 = (Assignment)cGroup.eContents().get(8);
		private final RuleCall cReq_eventsRequiredBlockParserRuleCall_8_0 = (RuleCall)cReq_eventsAssignment_8.eContents().get(0);
		private final Keyword cORDERKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Assignment cOrderAssignment_10 = (Assignment)cGroup.eContents().get(10);
		private final RuleCall cOrderOrderParserRuleCall_10_0 = (RuleCall)cOrderAssignment_10.eContents().get(0);
		private final Group cGroup_11 = (Group)cGroup.eContents().get(11);
		private final Keyword cCONSTRAINTSKeyword_11_0 = (Keyword)cGroup_11.eContents().get(0);
		private final Assignment cReqConstraintsAssignment_11_1 = (Assignment)cGroup_11.eContents().get(1);
		private final RuleCall cReqConstraintsEnforceConsBlockParserRuleCall_11_1_0 = (RuleCall)cReqConstraintsAssignment_11_1.eContents().get(0);
		private final Group cGroup_12 = (Group)cGroup.eContents().get(12);
		private final Keyword cREQUIRESKeyword_12_0 = (Keyword)cGroup_12.eContents().get(0);
		private final Assignment cRequireAssignment_12_1 = (Assignment)cGroup_12.eContents().get(1);
		private final RuleCall cRequireRequiresBlockParserRuleCall_12_1_0 = (RuleCall)cRequireAssignment_12_1.eContents().get(0);
		private final Group cGroup_13 = (Group)cGroup.eContents().get(13);
		private final Keyword cENSURESKeyword_13_0 = (Keyword)cGroup_13.eContents().get(0);
		private final Assignment cEnsureAssignment_13_1 = (Assignment)cGroup_13.eContents().get(1);
		private final RuleCall cEnsureEnsuresBlockParserRuleCall_13_1_0 = (RuleCall)cEnsureAssignment_13_1.eContents().get(0);
		private final Group cGroup_14 = (Group)cGroup.eContents().get(14);
		private final Keyword cNEGATESKeyword_14_0 = (Keyword)cGroup_14.eContents().get(0);
		private final Assignment cDestroyAssignment_14_1 = (Assignment)cGroup_14.eContents().get(1);
		private final RuleCall cDestroyDestroysBlockParserRuleCall_14_1_0 = (RuleCall)cDestroyAssignment_14_1.eContents().get(0);
		
		//MetaCrysl:
		//	'ABSTRACT'? 'SPEC' javaType=[jvmTypes::JvmType|QualifiedName] (array="[]" | "<" genericType=QualifiedName ">")?
		...
		//'ABSTRACT'? 'SPEC' javaType=[jvmTypes::JvmType|QualifiedName] (array="[]" | "<" genericType=QualifiedName ">")?
		//'OBJECTS' usage=UseBlock ('FORBIDDEN' forbEvent=ForbiddenBlock)? 'EVENTS' req_events=RequiredBlock 'ORDER' order=Order
		//('CONSTRAINTS' reqConstraints=EnforceConsBlock)? ('REQUIRES' require=RequiresBlock)? ('ENSURES' ensure=EnsuresBlock)?
		...
		//javaType=[jvmTypes::JvmType|QualifiedName]
		public Assignment getJavaTypeAssignment_2() { return cJavaTypeAssignment_2; }
		
		//[jvmTypes::JvmType|QualifiedName]
		public CrossReference getJavaTypeJvmTypeCrossReference_2_0() { return cJavaTypeJvmTypeCrossReference_2_0; }
		
		//QualifiedName
		public RuleCall getJavaTypeJvmTypeQualifiedNameParserRuleCall_2_0_1() { return cJavaTypeJvmTypeQualifiedNameParserRuleCall_2_0_1; }
		
		//(array="[]" | "<" genericType=QualifiedName ">")?
		...
		//"[]"
		public Keyword getArrayLeftSquareBracketRightSquareBracketKeyword_3_0_0() { return cArrayLeftSquareBracketRightSquareBracketKeyword_3_0_0; }
		
		//"<" genericType=QualifiedName ">"
		...
		//genericType=QualifiedName
		public Assignment getGenericTypeAssignment_3_1_1() { return cGenericTypeAssignment_3_1_1; }
		
		//QualifiedName
		public RuleCall getGenericTypeQualifiedNameParserRuleCall_3_1_1_0() { return cGenericTypeQualifiedNameParserRuleCall_3_1_1_0; }
		
		//">"
		public Keyword getGreaterThanSignKeyword_3_1_2() { return cGreaterThanSignKeyword_3_1_2; }
		
		//'OBJECTS'
		public Keyword getOBJECTSKeyword_4() { return cOBJECTSKeyword_4; }
		
		//usage=UseBlock
		public Assignment getUsageAssignment_5() { return cUsageAssignment_5; }
		
		//UseBlock
		public RuleCall getUsageUseBlockParserRuleCall_5_0() { return cUsageUseBlockParserRuleCall_5_0; }
		...
		public Assignment getForbEventAssignment_6_1() { return cForbEventAssignment_6_1; }
		
		//ForbiddenBlock
		public RuleCall getForbEventForbiddenBlockParserRuleCall_6_1_0() { return cForbEventForbiddenBlockParserRuleCall_6_1_0; }
		
		//'EVENTS'
		public Keyword getEVENTSKeyword_7() { return cEVENTSKeyword_7; }
		
		//req_events=RequiredBlock
		public Assignment getReq_eventsAssignment_8() { return cReq_eventsAssignment_8; }
		
		//RequiredBlock
		public RuleCall getReq_eventsRequiredBlockParserRuleCall_8_0() { return cReq_eventsRequiredBlockParserRuleCall_8_0; }
		
		//'ORDER'
		public Keyword getORDERKeyword_9() { return cORDERKeyword_9; }
		
		//order=Order
		public Assignment getOrderAssignment_10() { return cOrderAssignment_10; }
		
		//Order
		public RuleCall getOrderOrderParserRuleCall_10_0() { return cOrderOrderParserRuleCall_10_0; }
		...
		public Assignment getReqConstraintsAssignment_11_1() { return cReqConstraintsAssignment_11_1; }
		
		//EnforceConsBlock
		public RuleCall getReqConstraintsEnforceConsBlockParserRuleCall_11_1_0() { return cReqConstraintsEnforceConsBlockParserRuleCall_11_1_0; }
		...
		public Assignment getRequireAssignment_12_1() { return cRequireAssignment_12_1; }
		
		//RequiresBlock
		public RuleCall getRequireRequiresBlockParserRuleCall_12_1_0() { return cRequireRequiresBlockParserRuleCall_12_1_0; }
		
		//('ENSURES' ensure=EnsuresBlock)?
		public Group getGroup_13() { return cGroup_13; }
		
		//'ENSURES'
		public Keyword getENSURESKeyword_13_0() { return cENSURESKeyword_13_0; }
		
		//ensure=EnsuresBlock
		public Assignment getEnsureAssignment_13_1() { return cEnsureAssignment_13_1; }
		
		//EnsuresBlock
		public RuleCall getEnsureEnsuresBlockParserRuleCall_13_1_0() { return cEnsureEnsuresBlockParserRuleCall_13_1_0; }
		
		//('NEGATES' destroy=DestroysBlock)?
		public Group getGroup_14() { return cGroup_14; }
		
		//'NEGATES'
		public Keyword getNEGATESKeyword_14_0() { return cNEGATESKeyword_14_0; }
		
		//destroy=DestroysBlock
		public Assignment getDestroyAssignment_14_1() { return cDestroyAssignment_14_1; }
		
		//DestroysBlock
		public RuleCall getDestroyDestroysBlockParserRuleCall_14_1_0() { return cDestroyDestroysBlockParserRuleCall_14_1_0; }
	}
	...
	public class JvmParameterizedTypeRefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.JvmParameterizedTypeRef");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class JvmArgumentTypeRefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.JvmArgumentTypeRef");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class JvmWildcardTypeRefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.JvmWildcardTypeRef");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConsElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cLeftCurlyBracketKeyword_0_2_0_0 = (Keyword)cGroup_0_2_0.eContents().get(0);
		private final Assignment cLitsleftAssignment_0_2_0_1 = (Assignment)cGroup_0_2_0.eContents().get(1);
		private final RuleCall cLitsleftLitListParserRuleCall_0_2_0_1_0 = (RuleCall)cLitsleftAssignment_0_2_0_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_0_2_0_2 = (Keyword)cGroup_0_2_0.eContents().get(2);
		private final Assignment cMetaVariableAssignment_0_2_1 = (Assignment)cAlternatives_0_2.eContents().get(1);
		private final RuleCall cMetaVariableMETA_VARIABLETerminalRuleCall_0_2_1_0 = (RuleCall)cMetaVariableAssignment_0_2_1.eContents().get(0);
		...
		//	cons=ArrayElements "in" ("{" litsleft=LitList "}" | metaVariable=META_VARIABLE) | cons=LiteralExpression;
		@Override public ParserRule getRule() { return rule; }
		
		//cons=ArrayElements "in" ("{" litsleft=LitList "}" | metaVariable=META_VARIABLE) | cons=LiteralExpression
		public Alternatives getAlternatives() { return cAlternatives; }
		
		//cons=ArrayElements "in" ("{" litsleft=LitList "}" | metaVariable=META_VARIABLE)
		public Group getGroup_0() { return cGroup_0; }
		...
		//"{" litsleft=LitList "}" | metaVariable=META_VARIABLE
		...
		//"{"
		public Keyword getLeftCurlyBracketKeyword_0_2_0_0() { return cLeftCurlyBracketKeyword_0_2_0_0; }
		
		//litsleft=LitList
		public Assignment getLitsleftAssignment_0_2_0_1() { return cLitsleftAssignment_0_2_0_1; }
		
		//LitList
		public RuleCall getLitsleftLitListParserRuleCall_0_2_0_1_0() { return cLitsleftLitListParserRuleCall_0_2_0_1_0; }
		
		//"}"
		public Keyword getRightCurlyBracketKeyword_0_2_0_2() { return cRightCurlyBracketKeyword_0_2_0_2; }
		
		//metaVariable=META_VARIABLE
		public Assignment getMetaVariableAssignment_0_2_1() { return cMetaVariableAssignment_0_2_1; }
		
		//META_VARIABLE
		public RuleCall getMetaVariableMETA_VARIABLETerminalRuleCall_0_2_1_0() { return cMetaVariableMETA_VARIABLETerminalRuleCall_0_2_1_0; }
	...
	public class PredLitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.PredLit");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cGroup.eContents().get(0);
		private final Assignment cConsAssignment_0_0 = (Assignment)cGroup_0.eContents().get(0);
	...
	private final AddConstraintsElements pAddConstraints;
	private final AddConstraintElements pAddConstraint;
	private final MetaCryslElements pMetaCrysl;
	...
	private final TerminalRule tMETA_VARIABLE;
	...
	public CryptSLGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pAddConstraints = new AddConstraintsElements();
		this.pAddConstraint = new AddConstraintElements();
		this.pMetaCrysl = new MetaCryslElements();
		...
		this.tMETA_VARIABLE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "de.darmstadt.tu.crossing.CryptSL.META_VARIABLE");
	...
	//AddConstraints:
	//	addConstraints+=AddConstraint;
	public AddConstraintsElements getAddConstraintsAccess() {
		return pAddConstraints;
	}
	
	public ParserRule getAddConstraintsRule() {
		return getAddConstraintsAccess().getRule();
	}
	...
	//	'EVENTS' req_events=RequiredBlock 'ORDER' order=Order ('CONSTRAINTS' reqConstraints=EnforceConsBlock)? ('REQUIRES'
	//	require=RequiresBlock)? ('ENSURES' ensure=EnsuresBlock)? ('NEGATES' destroy=DestroysBlock)?;
	public MetaCryslElements getMetaCryslAccess() {
		return pMetaCrysl;
	}
	
	public ParserRule getMetaCryslRule() {
		return getMetaCryslAccess().getRule();
	}
	...
	//terminal META_VARIABLE:
	//	'$' ID;
	public TerminalRule getMETA_VARIABLERule() {
		return tMETA_VARIABLE;
	}
